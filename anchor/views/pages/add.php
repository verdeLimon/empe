...
<form method="post" action="<?php echo Uri::to('admin/pages/add'); ?>" enctype="multipart/form-data" novalidate>
    ...
    <fieldset class="header">
        <div class="wrap">
            ...
            <?php
            echo Form::text('title', Input::previous('title'), array(
            ...
            <aside class="buttons">
                ...
                <?php
                echo Form::button(__('pages.redirect'), array(
                    'class' => 'btn secondary redirector'
                ));
                ?>

                <?php
                echo Html::link('admin/pages', __('global.cancel'), array(
    ...
    <fieldset class="redirect">
        <div class="wrap">
            <?php
            echo Form::text('redirect', Input::previous('redirect'), array(
    ...
    <fieldset class="main">
        <div class="wrap">
            <?php
            echo Form::textarea('markdown', Input::previous('markdown'), array(
