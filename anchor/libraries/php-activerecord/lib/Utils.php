...
class Utils {
    ...
    public static function results_to_json($data, $options = null) {
        $out = "[";
        foreach ($data as $row) {
            if (!is_null($options)) {
    ...
    public static function results_to_array($data, $options = null) {
        $out = array();
        foreach ($data as $row) {
            if (!is_null($options)) {
    ...
    public static function results_to_string($data, $separator = ', ') {
        $out = "";
        $sep = '';
        foreach ($data as $row) {
            $out .= $sep;
            $out .= date("d-m-Y", strtotime($row->fechap));
            $sep = $separator;
        }
        $out = rtrim($out, ',');
        $out .= "";
